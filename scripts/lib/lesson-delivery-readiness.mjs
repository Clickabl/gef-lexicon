...
export function implementationResolution(part, lessonId = null) {
  ...
  if (ids.length === 0) return { status: 'unavailable', reason: 'no_implementation_lesson' };
  if (ids.length > 1) {
    return {
      status: 'ambiguous',
  ...
  if (lessonId !== null && resolved !== lessonId) return { status: 'unavailable', reason: 'lesson_not_bound_to_part' };
